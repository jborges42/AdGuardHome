...
class Logs extends Component {
    ...
    getResponseCell = ({ value: responses, original }) => {
        ...
        const isResponsePresent = responses.length > 0;
        ...
        if (filterId === 0) {
            ...
            const filterItem = Object.keys(filters).filter(key => filters[key].id === filterId);

            if (
                typeof filterItem !== 'undefined' &&
                typeof filters[filterItem[0]] !== 'undefined'
            ) {
                filterName = filters[filterItem[0]].name;
            }
        ...
        return (
            <div className="logs__row logs__row--column">
                ...
                <div className="logs__list-wrap">
                    {isResponsePresent ? (
                        this.renderResponseList(responses)
                    ) : (
                        <div>
